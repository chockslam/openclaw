...
export const DEFAULT_MEMORY_FLUSH_PROMPT = [
  ...
  "Store durable memories now using memory_search and memory_get; do not guess or read memory/YYYY-MM-DD.md directly.",
  `If nothing to store, reply with ${SILENT_REPLY_TOKEN}.`,
].join(" ");

export const DEFAULT_MEMORY_FLUSH_SYSTEM_PROMPT = [
  "Pre-compaction memory flush turn.",
  "The session is near auto-compaction; capture durable memories via DB-native memory tools.",
