...
export function buildServiceEnvironment(params: {
  ...
  return {
    ...
    OPENCLAW_STORAGE_POSTGRES_URL: env.OPENCLAW_STORAGE_POSTGRES_URL,
    OPENCLAW_STORAGE_POSTGRES_SCHEMA: env.OPENCLAW_STORAGE_POSTGRES_SCHEMA,
    OPENCLAW_STORAGE_POSTGRES_SESSIONS_TABLE: env.OPENCLAW_STORAGE_POSTGRES_SESSIONS_TABLE,
    OPENCLAW_STORAGE_POSTGRES_TRANSCRIPTS_TABLE: env.OPENCLAW_STORAGE_POSTGRES_TRANSCRIPTS_TABLE,
    OPENCLAW_STORAGE_POSTGRES_AUDIT_TABLE: env.OPENCLAW_STORAGE_POSTGRES_AUDIT_TABLE,
    OPENCLAW_STORAGE_POSTGRES_TENANT_ID: env.OPENCLAW_STORAGE_POSTGRES_TENANT_ID,
    OPENCLAW_STORAGE_POSTGRES_TENANT_SLUG: env.OPENCLAW_STORAGE_POSTGRES_TENANT_SLUG,
    OPENCLAW_STORAGE_POSTGRES_DEFAULT_AGENT_ID: env.OPENCLAW_STORAGE_POSTGRES_DEFAULT_AGENT_ID,
    OPENCLAW_STORAGE_POSTGRES_MAX_CONNECTIONS: env.OPENCLAW_STORAGE_POSTGRES_MAX_CONNECTIONS,
    OPENCLAW_STORAGE_POSTGRES_SSL: env.OPENCLAW_STORAGE_POSTGRES_SSL,
    OPENCLAW_POSTGRES_URL: env.OPENCLAW_POSTGRES_URL,
    OPENCLAW_MEMORY_POSTGRES_URL: env.OPENCLAW_MEMORY_POSTGRES_URL,
